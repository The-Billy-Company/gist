...
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------ |
| `simd_contains.zig` | [`../../../src/kernel/match/scan/simd.zig`](../../../src/kernel/match/scan/simd.zig)'s `contains` vector filter                             | throughput-bound (independent iterations)  |
| `dfa_step.zig`      | [`../../../src/kernel/match/regex/linear/dfa/dfa.zig`](../../../src/kernel/match/regex/linear/dfa/dfa.zig)'s `Dfa.docMatch` transition loop | latency-bound (loop-carried pointer chase) |
