...
| `dfa_step.zig`      | [`../../../src/kernel/match/regex/linear/dfa.zig`](../../../src/kernel/match/regex/linear/dfa.zig)'s `Dfa.docMatch` transition loop | latency-bound (loop-carried pointer chase) |
