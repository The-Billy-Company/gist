...
| ------------------- | --------------------------------------------------------------------------------------------------------------------- | ------------------------------------------ |
| `simd_contains.zig` | [`../../../src/search/match/scan/simd.zig`](../../../src/search/match/scan/simd.zig)'s `contains` vector filter       | throughput-bound (independent iterations)  |
| `dfa_step.zig`      | [`../../../src/search/match/regex/dfa.zig`](../../../src/search/match/regex/dfa.zig)'s `Dfa.docMatch` transition loop | latency-bound (loop-carried pointer chase) |
