...
[`../harness/`](../harness/README.md); this half proves the *end-to-end* claim
...
The verdict is **fail-closed** — a WIN needs a lower median *and*
...
admits *every* file — the cases the competition is built to win.
