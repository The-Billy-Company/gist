...
the one entry point (`make bench-gist-certify`); the rest are lanes it splices
...
| File        | Lane                                                                                                                                                                             |
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `mint.sh`   | full A–G mint — Layer A micro (+ optional sudo PMU) + macroscopic field race + warm tier + `--rank` lane + relate, auto-calls `splice.sh`; the `make bench-gist-certify` default |
