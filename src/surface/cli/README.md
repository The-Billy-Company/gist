...
doc_radar:
  ...
  sentinels:
    ...
    - file: pkg/kernels/irregex/src/surface/cli/beacon.zig
      description: the hyperlink layer keeps its four decisions separate — read a value, judge the terminal, pick a destination, split a per-file URL
      contains: ["pub fn wish", "pub fn speaks", "pub fn destination", "pub const Waypoint"]
    - file: pkg/kernels/irregex/src/surface/cli/reprise.zig
