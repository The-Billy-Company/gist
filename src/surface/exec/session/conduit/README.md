...
doc_radar:
  paths_exist:
    - pkg/kernels/irregex/src/surface/exec/session/conduit/protocol/protocol.zig
  ...
  sentinels:
    - file: pkg/kernels/irregex/src/surface/exec/session/conduit/protocol/protocol.zig
      contains: ["protocol_version: u8 = 8", "cap_fd_transport", "caps_supported"]
      description: The negotiated contract head the entry file owns — version plus the additive HELLO capability byte
    - file: pkg/kernels/irregex/src/surface/exec/session/conduit/protocol/frame.zig
    ...
    - file: pkg/kernels/irregex/src/surface/exec/session/conduit/protocol/query.zig
